...
select EmployeeName, sum(saleamount) from employeesales;


-- Q. what will be the total amount of each employee
...
select *,
sum(saleamount) over(order by saledate desc) from employeesales;
